...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var cssText = [
      ...
      "}",
      "." + cssClass.grid + "{" +
        "display:flex;align-items:flex-end;gap:14px;padding:12px 0;" +
      "}",
      "." + cssClass.cell + "{" +
        "flex:1;min-width:0;display:flex;flex-direction:column;gap:7px;" +
      "}",
      "." + cssClass.cellLabel + "{font-size:12px;color:var(--dsw-alias-label-secondary);}",
      ...
      "." + cssClass.swatch + "{" +
        ...
        "min-width:0;width:100%;padding:5px 9px;" +
